...
class ChatView(APIView):
    ...
    def post(self, request):
        ...
        formatted_prompt = (
            ...
            "If the dialogue is from a movie, non english film or unknown, respond exactly with: 'Dialogue not found'.\n\n"
        ...
        if chat_response.strip().lower() == "dialogue not found":
            chat_response = (
                ...
                "It may belong to a Movie, non english film or is not widely recognized in TV series history."
            )
